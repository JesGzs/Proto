...
module.exports = {
  ...
  const name = args.join(' ')
        if(!name) return message.reply('Proporcionar un usuario válido para buscar.') // If User Is Not Found On GitHub
        ...
        try{
            ...
            return message.reply('Ocurrió un error, inténtalo de nuevo más tarde.')
        }
