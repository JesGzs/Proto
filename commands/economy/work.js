...
const ms = require("parse-ms");
  ...
  execute: async(client, message, args) => {
    ...
    if (author !== null && timeout - (Date.now() - author) > 0) {
        ...
        .setColor("RANDOM")
        .setDescription(`:x:  Ya has trabajado recientemente\n\nInténtalo de nuevo in ${time.minutes}m ${time.seconds}s `);
        ...
        .setColor("RANDOM")
        .setDescription(`:white_check_mark: Trabajaste como un ${replies[result]} y ganado ${amount} coins`);
